...
;hljs.registerLanguage("accesslog",e)})();/*! `bash` grammar compiled for Highlight.js 11.10.0 */
...
begin:`(?!-)${i}--+|--+(?!-)${i}`},s,{begin:"->|<-"}]}}})()
;hljs.registerLanguage("haskell",e)})();/*! `ini` grammar compiled for Highlight.js 11.10.0 */
...
;hljs.registerLanguage("plaintext",t)})();/*! `prolog` grammar compiled for Highlight.js 11.10.0 */
